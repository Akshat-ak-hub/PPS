...
//               </div>
//               <div>
//                 <h3 className="font-display text-xl font-bold">Priya Public School</h3>
//                 <p className="text-sm opacity-80">Himachal Pradesh</p>
//               </div>
//             </Link>
//             <p className="text-sm opacity-80 leading-relaxed mb-6">
//               {schoolInfo.tagline}. Providing quality education since {schoolInfo.founded}.
//             </p>
...
//                 <span className="text-sm opacity-80">{schoolInfo.phone}</span>
//               </li>
//               <li className="flex items-center gap-3">
